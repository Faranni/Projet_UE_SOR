...
<form method="post" action="ServletConsultation">
	<div class="row">
		...
		<button class="btn waves-effect waves-light" type="submit" name="filtrerMois">
...
<form class="col s6" method="post" action="ServletConsultation">
	<div class="row">
		...
		<button class="btn waves-effect waves-light" type="submit" name="filtrerJour">
			Filtrer <i class="material-icons right">send</i>
		</button>
	</div>
</form>
...
<form class="col s6" method="post" action="ServletConsultation">
	...
	<div class="row">
		<button class="btn waves-effect waves-light" type="submit" name="genererPdf">
					...
					<c:if test="${! entry.value.isEmpty()}">
						<div>
							<c:forEach var="image" items="${entry.value}">
								<img src="data:image/png;base64,${ image }" width="100px"
									height="100px" />
							</c:forEach>
						</div>
					</c:if>
